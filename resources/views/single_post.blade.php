            ...
            <div class="d-flex flex-column comment-section">
                <div class="bg-white p-2">
                    ...
                    <div class="mt-2">
                        ...
                        <img class="img-fluid" src="{{URL::asset('/storage/uploads/posts/'.$single_post->post_image)}}">
                    </div>
                </div>
                ...
                <div class="comment">
                    ...
                    <div class="d-flex flex-row justify-content-start align-items-start py-2">
                        ...
                        <img class="rounded-circle" src="{{URL::asset('/storage/uploads/profiles/'.$user->image )}}" width="40">
                ...
                <div class="bg-light p-2">
                    ...
                    <div class="d-flex flex-row align-items-start">
                        <img class="rounded-circle" src="{{URL::asset('/storage/uploads/profiles/'. Auth::user()->image)}}" width="40">
