                        ...
                        <div class="d-flex justify-content-between row my-2">
                            ...
                            <div class="col-md-5 border border-warning my-2">
                                <div class="d-flex flex-column comment-section">
                                    ...
                                    <div class="bg-white">
                                        <div class="d-flex flex-row fs-12"><span class="ml-1 mb-2"><a href="{{route('single.post', $posts->id)}}" class='btn btn-sm btn-warning'>Read More</a></span></div>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                        ...
                        <div class="container">
                            ...
                            <div class="tab-class text-center">
                                <ul class="nav nav-pills d-inline-flex justify-content-center bg-dark text-uppercase border-inner p-4 mb-5">
                                    <li class="nav-item" data-filter=".Best-Seller">
                                        <a class="nav-link text-white active" data-bs-toggle="pill" href=".Best-Seller">Best Seller</a>
                                    </li>
                                    <li class="nav-item" data-filter=".new-arrivals">
                                        <a class="nav-link text-white" data-bs-toggle="pill" href=".new-arrivals">New Arrivals</a>
                                    </li>
                                    <li class="nav-item" data-filter=".hot-sales">
                                        <a class="nav-link text-white" data-bs-toggle="pill" href=".hot-sales" >Hot Sales</a>
                                    </li>
                                </ul>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-item">
                                        ...
                                        <div class="bg-dark border-inner text-center p-4">
                                            <h4 class="text-uppercase text-primary">{{$team->name}}</h4>
                                            <p class="text-white m-0">{{$team->role}}</p>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
